        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4 group">
              <div className="flex h-6 w-6 items-center justify-center rounded bg-black text-white font-bold text-xs shadow-sm transition-transform group-hover:scale-110">
                T
              </div>
